...
service_config = {
    "nginx-thrift":         {'max_replica': 8, 'max_replicas_per_node': 4, 'max_cpus': 64},
    "compose-post-service": {'max_replica': 4, 'max_cpus': 8},
    "compose-post-redis":   {'max_replica': 1, 'max_cpus': 8},
    "text-service":         {'max_replica': 4, 'max_cpus': 8},
    "text-filter-service":  {'max_replica': 4, 'max_cpus': 8},
    "user-service":         {'max_replica': 4, 'max_cpus': 8},
    "user-memcached":       {'max_replica': 1, 'max_cpus': 8},
    "user-mongodb":         {'max_replica': 1, 'max_cpus': 8},
    "media-service":        {'max_replica': 4, 'max_cpus': 8},
    "media-filter-service": {'max_replica': 16, 'max_replicas_per_node': 1, 'max_cpus': 256},
    "unique-id-service":    {'max_replica': 4, 'max_cpus': 8},
    "url-shorten-service":  {'max_replica': 4, 'max_cpus': 8},
    "user-mention-service": {'max_replica': 4, 'max_cpus': 8},
    # "post-storage-service": {'max_replica': 1, 'max_cpus': 16},
    "post-storage-service": {'max_replica': 8, 'max_replicas_per_node': 4, 'max_cpus': 32},
    "post-storage-memcached":   {'max_replica': 1, 'max_cpus': 8},
    "post-storage-mongodb":     {'max_replica': 1, 'max_cpus': 8},
    "user-timeline-service":    {'max_replica': 4, 'max_cpus': 8},
    "user-timeline-redis":      {'max_replica': 1, 'max_cpus': 8},
    "user-timeline-mongodb":    {'max_replica': 1, 'max_cpus': 8},
    "write-home-timeline-service":  {'max_replica': 4, 'max_cpus': 8},
    "write-home-timeline-rabbitmq": {'max_replica': 4, 'max_cpus': 8},
    "write-user-timeline-service":  {'max_replica': 4, 'max_cpus': 8},
    "write-user-timeline-rabbitmq": {'max_replica': 4, 'max_cpus': 8},
    "home-timeline-service":    {'max_replica': 4, 'max_cpus': 32},
    "home-timeline-redis":      {'max_replica': 1, 'max_cpus': 8},
    "social-graph-service":     {'max_replica': 4, 'max_cpus': 8},
    "social-graph-redis":   {'max_replica': 1, 'max_cpus': 8},
    "social-graph-mongodb": {'max_replica': 1, 'max_cpus': 8}
    # "jaeger": {"replica": 1}
}
